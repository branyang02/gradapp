...
\statement{Why NYU} I am interested in working with \href{https://mengyeren.com/}{\textbf{Prof. Mengye Ren}} because his research on human-like embodied agents aligns closely with my experiences and aspirations. His recent work, \textit{CoLLEGe}, investigates concept learning and abstraction in LLMs, which resonates with my goal of developing agents capable of acquiring semantic skills and concepts. Additionally, his focus on learning from visual experience, such as \textit{PooDLe}, explores a novel objective for self-supervised learning. This area has great potential for embodied agents that must learn from their own physical-world experiences, which also aligns with my interest in achieving more robot autonomy for complex tasks. I am also excited about the opportunity to collaborate with \href{https://www.sainingxie.com/}{\textbf{Prof. Saining Xie}}, whose research on robust visual intelligence complements my interest in perception systems for embodied agents. His recent work on grounding factual knowledge and designing novel fine-tuning strategies for vision-language models is impactful for advancing generalist robotic policy research. In addition, I look forward to the opportunity to work with \href{https://hhexiy.github.io/}{\textbf{Prof. He He}}, who focuses on truthful machine learning and human-AI collaboration. Her research on developing models capable of reasoning and collaborating with humans aligns directly with my goals. I am especially interested in investigating how these techniques can be extended to embodied agents.
