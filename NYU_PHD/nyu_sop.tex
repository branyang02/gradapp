...
\statement{Why NYU} I am interested in working with \href{https://www.sainingxie.com/}{\textbf{Prof. Saining Xie}} because his research on robust visual intelligence complements my interest in perception systems for embodied agents. His recent work on grounding factual knowledge and designing novel fine-tuning strategies for vision-language models is particularly relevant to advancing generalist robotic policy research. I am also excited about collaborating with \href{https://www.lerrelpinto.com/}{\textbf{Prof. Lerrel Pinto}}, whose innovative research on integrating foundational models with robotic systems aligns with my goals. Projects like BAKU, OK-Robot, and RUM demonstrate how foundational models can enable more robust and generalist robotic policies, which is directly connected to my interest in creating autonomous systems capable of handling complex tasks. Additionally, I am eager to work with \href{https://mengyeren.com/}{\textbf{Prof. Mengye Ren}}, whose research on human-like embodied agents closely aligns with my aspirations. His work, such as \textit{CoLLEGe}, on concept learning and abstraction in LLMs resonates with my goal of developing agents capable of acquiring and utilizing semantic skills. Furthermore, his exploration of self-supervised learning objectives, such as in \textit{PooDLe}, offers exciting potential for embodied agents learning from physical-world experiences. Lastly, I look forward to the opportunity to collaborate with \href{https://hhexiy.github.io/}{\textbf{Prof. He He}}, whose research on truthful machine learning and human-AI collaboration directly aligns with my interests. Her work on developing models that reason and collaborate effectively with humans offers promising pathways for extending these capabilities to embodied agents.

\noindent Finally, I am enthusiastic about the many research communities at NYU, specifically the CILVR Lab, which fosters collaborative and interdisciplinary work within AI. This is particularly attractive to me because I want to actively learn from and collaborate with researchers across these fields, enabling broader impact for my own research and future directions.
