...
\statement{Why TTIC} The Toyota Technological Institute at Chicago (TTIC) is the ideal place to pursue my research in robotics due to its strong emphasis on the intersection of robotics, CV, and NLP. I am particularly interested in the work of \href{https://home.ttic.edu/~mwalter/}{\textbf{Prof. Matthew Walter}}. His research on intelligent, perceptually aware robots that collaborate with humans aligns directly with my vision of collaborative robots. In the \href{https://ttic.edu/ripl/}{\textbf{Robot Intelligence through Perception Lab}}, Prof. Walter also places an emphasis on langauge comprehension and generation for robots in physical tasks. While his current work focuses on language generation for robotic navigation, I am eager to explore its applications in manipulation tasks as well.

I am also interested to collaborate with \href{https://home.ttic.edu/~gregory/}{\textbf{Prof. Greg Shakhnarovich}} and \href{https://shiry.ttic.edu/}{\textbf{Prof. Shiry Ginosar}}, who both work in CV with potential applications to robotics. Prof. Shakhnarovich's emphasis on grounding language in the 3D visual world resonates with my experience in grounding and reasoning in both 2D and 3D environments. Continuing this line of work could enable embodied agents to understand language-grounded scenes more effectively. Prof. Ginosar's research on 3D Gaussian Splatting and diffusion models are foundational to my current work. I am excited to explore the potential of these models further in the context of robotic perception and manipulation.
