...
\statement{Why UMass Amherst} UMass Amherst's M.S./Ph.D. program stands out for its pioneering research in robotics and AI. I am particularly drawn to the work of \href{https://people.csail.mit.edu/ganchuang/}{\textbf{Prof. Chuang Gan}}, whose research lies at the intersection of AI, computer vision, and robotics. His efforts in building human-like autonomous agents, such as \textit{RoboGen} and \textit{3D-LLM}, align closely with my focus on integrating skill learning and 3D representations with robot perception and manipulation. Similarly, \href{https://hcr.cs.umass.edu/people/hzhang/}{\textbf{Prof. Hao Zhang}}'s work on lifelong collaborative autonomy and robot-human teaming resonates with my interest in enabling robots to communicate and collaborate in complex settings. My experience in vision and language-guided robot learning can contribute to developing adaptive policies for collaborative agents. Moreover, \href{https://people.cs.umass.edu/~sniekum/}{\textbf{Prof. Scott Niekum}}'s focus on aligning AI systems with human objectives and ensuring safe deployment complements my research trajectory, and my past experience in MARL can contribute to his work on collaborative autonomy. Finally, \href{https://people.cs.umass.edu/~smaji/}{\textbf{Prof. Subhransu Maji}}'s research in high-level visual recognition algorithms aligns with my interest in integrating 3D semantic understanding into robotics.

UMass Amherst provides the ideal environment to advance these aspirations. Under the mentorship of its distinguished faculty, I plan to further explore innovative solutions for robotic perception, planning, and collaboration. I am confident that my background, combined with the resources and expertise at UMass Amherst, will enable me to make contributions to robotics and AI research while preparing me for a career as a future professor or industry research scientist in this domain.
\end{document}