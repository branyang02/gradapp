...
\statement{Why UVA?} UVA is the ideal environment for me to pursue my research goals due to its interdisciplinary focus on AI, robotics, and NLP. I would like to continue working with \href{https://yenlingkuo.com/}{\textbf{Prof. Yen-Ling Kuo}}, exploring how language can enhance the generalization of robotic policies in human-interactive environments. I am also interested in collaborating with \href{https://cral-uva.github.io/people/rohan_chandra/index.html}{\textbf{Prof. Rohan Chandra}} on human-aware robot navigation, and how language can be used to refine these interactions in complex environments. Additionally, I am excited about \href{https://yumeng5.github.io/}{\textbf{Prof. Yu Meng}}'s focus on NLP, specifically his projects on LLM alignment and reasoning, which could support embodied agents in reasoning through language.

\noindent I believe my strong technical and research background in robotics, NLP, and computer vision, along with my passion for developing embodied agents capable of autonomous reasoning and planning, makes me a strong candidate for UVA's Ph.D. program. In addition to the professors mentioned above, I am excited to collaborate and learn from researchers in the interdisciplinary fields at UVA, such as those in the Link Lab or the School of Data Science. I am confident in my ability to work with professors of any advising style. I have had hands-on as well as hands-off advising experiences, and I am adaptable to different research environments. Additionally, I excel in collaborative work, as evidenced by my leadership roles in the projects I have worked on. I hope to become a professor or research scientist in the future, and I believe UVA's research community and resources will provide me with the necessary training and mentorship to achieve this goal.
